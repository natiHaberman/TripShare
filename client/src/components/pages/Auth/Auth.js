...
// Page where a user can log in or register
function Auth() {

  // Input requirements for log in and registration
  ...
  // Error messages for log in and registration
  ...
  // Handle submission of log in and registration forms using functions from auth-hook
  ...
  // Handle validation of log in and registration forms before submission
